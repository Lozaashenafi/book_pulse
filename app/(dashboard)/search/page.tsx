...
// --- Sub-Component: Search Bar (Ledger Style) ---
...
// --- Sub-Component: Category Filter (Library Index Style) ---
  ...
  useEffect(() => {
    const fetchCats = async () => {
      try {
        ...
        // Ensure we handle the relational object mapping
