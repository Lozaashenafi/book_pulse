  ...
  return (
    <section className="relative min-h-screen bg-[#fdfcf8] dark:bg-[#1a1614] pt-40 pb-20 overflow-hidden flex flex-col items-center transition-colors duration-500">
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        {/* Library Stamp Badge */}
        <div className="inline-block border-2 border-dashed border-[#1a3f22]/30 dark:border-[#d4a373]/30 p-2 rotate-[-2deg] mb-10 animate-in fade-in slide-in-from-top-4 duration-700">
          <div className="bg-[#f4ebd0] dark:bg-[#1a3f22]/20 px-4 py-1">
            <span className="text-[10px] font-mono font-black uppercase tracking-[0.3em] text-[#1a3f22] dark:text-[#d4a373]">
        ...
        <h1 className="text-6xl md:text-8xl font-serif font-black text-[#1a3f22] dark:text-gray-100 leading-[0.95] tracking-tighter mb-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-24">
          ...
          <button className="w-full sm:w-auto bg-transparent border-2 border-[#1a3f22]/20 dark:border-white/10 text-[#1a3f22] dark:text-[#d4a373] px-10 py-5 rounded-none font-serif font-bold text-lg hover:bg-[#1a3f22]/5 transition-all">
        ...
        <div className="mt-24 relative inline-block group">
          ...
          <div className="bg-[#f4ebd0] dark:bg-[#252525] p-8 border-2 border-[#d6c7a1] dark:border-[#3e2b22] shadow-xl max-w-lg relative rotate-1">
            ...
            <p className="italic font-serif text-xl text-[#1a3f22] dark:text-gray-200 leading-relaxed">
      ...
      <div className="absolute top-10 left-10 w-32 h-32 border-t-8 border-l-8 border-[#1a3f22]/5 dark:border-white/5 pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-32 h-32 border-b-8 border-r-8 border-[#d4a373]/10 pointer-events-none" />

      {/* Decorative Bookmark */}
      <div className="absolute top-0 right-20 w-12 h-40 bg-[#1a3f22] dark:bg-[#d4a373] shadow-md hidden lg:block animate-in slide-in-from-top-10 duration-1000">
...
const FeatureCard = ({
  ...
  <div
    className={`bg-white dark:bg-[#252525] p-8 border-t-4 border-[#1a3f22] dark:border-[#d4a373] shadow-md ${rotate} hover:rotate-0 transition-transform duration-300 flex flex-col items-center text-center space-y-4`}
  >
    <div className="w-12 h-12 bg-[#f4ebd0] dark:bg-[#1a3f22]/20 flex items-center justify-center text-[#1a3f22] dark:text-[#d4a373]">
      {icon}
    </div>
    <h3 className="font-serif font-black text-lg text-[#1a3f22] dark:text-gray-200">
      {title}
    </h3>
