          ...
          <main className="lg:col-span-8">
            {filteredBooks.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-32 text-center bg-white dark:bg-[#252525] border-2 border-dashed border-[#d6c7a1] dark:border-[#3e2b22]">
                <BookX size={60} className="text-tertiary opacity-20 mb-6" />
                <h3 className="text-2xl font-serif font-black text-tertiary dark:text-white">
                  No records found
                </h3>
                <button
                  onClick={() => {
                  ...
                  className="mt-6 font-mono text-[10px] font-bold uppercase tracking-widest text-tertiary underline decoration-dotted underline-offset-4"
                >
                  Reset Archives
                </button>
              </div>
